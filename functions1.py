...
def sendmail(email, subject, message_body , attachment_path=None ):
    SMTP_SERVER = "smtp.gmail.com"  #Find the Outgoing Server smtp.google.com
    SMTP_PORT = 587  #Port 465 or 587, 80 works for me. Check what will work for you in the Video
    EMAIL_ADDRESS = "creativeauthoronline@gmail.com" 
    EMAIL_PASSWORD = "dtil cwls dcai mogx"  

    sender = "creativeauthoronline@gmail.com" #The Email you want to send from P.S. You can customize this if you have a domain
    sender_name = "Star Creative" #Sender Name
    ...
    try:
        with smtplib.SMTP(SMTP_SERVER, SMTP_PORT) as server:
            server.starttls(context=context)  # Use starttls() for upgrading to a secure connection
...
def craft_message(csv_file,message=None,subject=None, author=None):
    ...
    for contact in extracted_data:
        ...
        sendmail(email, subject, personalized_email ,attachment_path)